...
class ReversePocoGeneratorGUI:
    def __init__(self, master):
        ...
        self.camelcase_radio.grid(row=8, column=1, sticky=tk.W, padx=5, pady=2)
        self.original_radio = ttk.Radiobutton(master, text="Original", variable=self.naming_convention, value="original")
        self.original_radio.grid(row=9, column=1, sticky=tk.W, padx=5, pady=2)

        # History Dropdown
        ttk.Label(master, text="Connection History:").grid(row=8, column=0, sticky=tk.W, padx=5, pady=5)
        self.history_var = tk.StringVar()
        self.history_dropdown = ttk.Combobox(master, textvariable=self.history_var)
        self.history_dropdown.grid(row=8, column=1, padx=5, pady=5)
